...
module.exports = {
  name: "sticker",
  description: "Hago stickers de imagen/gif/vídeo",
  commands: ["s", "sticker", "fig", "f"],
  usage: `${PREFIX}sticker (marca la imagen/gif/vídeo) o ${PREFIX}sticker (responde a la imagen/gif/vídeo)`,
  handle: async ({
    isImage,
    isVideo,
    downloadImage,
    ...
    if (!isImage && !isVideo) {
      throw new InvalidParameterError(
        "¡Debes marcar una imagen/gif/vídeo o responder a una imagen/gif/vídeo!"
      );
    }
    ...
    if (isImage) {
      ...
      if (!haveSecondsRule) {
        ...
        await sendErrorReply(`¡El vídeo que enviaste tiene más de ${sizeInSeconds} segundos!

¡Envía un vídeo más corto!`);
